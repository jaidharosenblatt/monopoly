...
public interface FrontEndExternal {
  ...
  /**
   * This method is used by the back end to prompt the player for an input to a set of responses.
   * An example of this is "Buy Property 1?" ,{"Yes","No"}
   * @param prompt Text displayed to player
   * @param possibleResponses choice of actions the player can take
   * @return The index corresponding to the chosen response by the user
   */
  public int makeUserDecision(String prompt, List<String> possibleResponses);

  /**
   * Use this method to refresh the players display after a turn has been completed. Specifically it will update the
